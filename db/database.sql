...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2016 at 01:28 AM
...
CREATE TABLE `default_seo` (
  `id_default_seo` int(11) NOT NULL,
...
ALTER TABLE `default_seo`
  ADD PRIMARY KEY (`id_default_seo`);
...
--
ALTER TABLE `default_seo`
  MODIFY `id_default_seo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
