...
<!-- SECTION KONTEN -->
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-12">
              <h3 class="title-v2">Ubah Password</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>','</div>'); ?>
                <?php echo form_open('member/password/proses_password',array('class'=>'form-horizontal')); ?>
                <!-- <form class="form-horizontal"> -->
                  <div class="form-group">
                      <label for="inputEmail" class="control-label col-sm-2">Password Lama</label>
                      <div class="col-sm-10">
                        <input name="password_lama" class="form-control" type="password"></input>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail" class="control-label col-sm-2">Password Baru</label>
                      <div class="col-sm-10">
                        <input name="password_baru" class="form-control" id="pass1" type="password"></input>
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail" class="control-label col-sm-2">Ulangi Password Baru</label>
                      <div class="col-sm-10">
                        <input name="password_baru2" class="form-control" id="pass2" onkeyup="checkPass(); return false;" type="password"></input><span id="confirmMessage" class="confirmMessage"></span>
                      </div>
                  </div>
                  <div class="form-group">
