              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  <div class="form-horizontal">
                    ...
                    <div class="row">
                      <label class="control-label col-lg-3 col-md-3 col-sm-3">Gambar</label>
                      <div class="col-lg-9 col-md-9 col-sm-9">
                        <img class="img-thumbnail img-responsive thumb_foto_md" src="<?php echo base_url('assets/uploads/users/'.$pelanggan->gambar); ?>">
                      </div>
                    </div>
                    <div class="row">
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  ...
                  <!-- <form class="form-horizontal"> -->
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Gambar</label>
                      <div class="col-lg-9">
                        <input required="" name="gambar" type="file" class="form-control"></input>  
                      </div>
                    </div>
                    <div class="form-group">
